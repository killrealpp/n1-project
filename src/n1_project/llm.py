...
def article_user_prompt(
    ...
    date_summary = f"Сводка за {article_date_label}:" if article_date_label else "Сводка за день:"
    return (
        ...
        "- Layout must be visually separated with blank lines:\n"
        "  1. Title sentence on its own line.\n"
        "  2. One blank line.\n"
        f"  3. Standalone date-summary line exactly like `{date_summary}`.\n"
        "  4. One blank line.\n"
        "  5. Body paragraphs.\n"
        "- Do not merge the title, date summary, and body into one paragraph.\n"
        ...
        f"2. Standalone date-summary line after a blank line: `{date_summary}`.\n"
        "3. Opening paragraph: what happened, which markets/companies are affected, and why it matters.\n"
        "4. Three to five compact blocks, each with one idea, one source-grounded fact set, and one careful takeaway.\n"
        "5. Short closing synthesis: what changed or what to watch next, without predictions beyond the source posts.\n\n"
        ...
        "- There is one blank line after the title.\n"
        "- The date-summary line is standalone and starts with `Сводка за`.\n"
        "- There is one blank line after the date-summary line.\n"
        "- The first body paragraph can stand alone as a card description.\n"
