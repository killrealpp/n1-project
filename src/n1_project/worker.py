...
async def amain() -> None:
    ...
    parser.add_argument("--dry-run", action="store_true", help="Do not call external publish APIs or Ollama")
    ...
    parser.add_argument("--doctor", action="store_true", help="Check env readiness and Ollama availability")
