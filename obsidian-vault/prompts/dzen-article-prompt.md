...
- Используй один из таких ходов, если он подходит к источникам: `Почему рынок испугался...`, `Что произошло...`, `Что теперь будет...`, `Почему это важно...`, `Что означает...`, `Что изменилось...`, `Рынок получил неожиданный сигнал...`, `Инвесторы не ожидали...`.
